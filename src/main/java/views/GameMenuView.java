    ...
    public static String  run(){
        ...
        while(true){
            ...
            if((matcher = Commands.getMatcher(command, Commands.PLAYGAME)) != null) {
                if (gameMenuController.playGame(matcher)) return "startGame";
            }
            else if((matcher = Commands.getMatcher(command,Commands.MENUEXIT)) != null) return "mainMenu";
            else if((matcher = Commands.getMatcher(command,Commands.SHOWMENU)) != null) System.out.println("game Menu");
