...
public enum UnitType {
    ...
    LONGSWORDSMAN(150, 18, 0, 0, 3, "MELEE", Resource.IRON, Technology.STEEL),
    PIKEMAN(100, 10, 0, 0, 2, "MELEE", null, Technology.CIVILSERVICE),
    TREBUCHET(170, 6, 20, 2, 2, "SIEGE", Resource.IRON, Technology.PHYSICS),
    CANON(250, 10, 26, 2, 2, "SIEGE", null, Technology.CHEMISTRY),
    CAVALRY(260, 25, 0, 0, 3, "MOUNTED", Resource.HORSE, Technology.MILITARYSCIENCE),
    ...
    ANTITANKGUN(300, 32, 0, 0, 2, "GUNPOWDER", null, Technology.REPLACEABLEPARTS),
